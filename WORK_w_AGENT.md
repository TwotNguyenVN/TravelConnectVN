...
A. Bộ 5 file lõi phải đọc toàn bộ mặc định:
1. `SESSION_SPRINT/TRAVEL_PROJECT_MASTER_SPEC_v3_FINAL.md`
2. `SESSION_SPRINT/PROJECT_STATUS.md`
3. `SESSION_SPRINT/PROJECT_TASK.md`
4. `SESSION_SPRINT/SPRINT_14.md` của sprint hiện tại
5. `SESSION_SPRINT/SESSION_LOG.md` file ghi lại lịch sử phiên làm việc
...
- sau đó đọc toàn bộ 4 file sau:
  1. `TRAVEL_PROJECT_MASTER_SPEC_v3_FINAL.md`
  2. `PROJECT_STATUS.md`
  3. `PROJECT_TASK.md`
  4. `SPRINT_14.md` hiện tại
- đọc `SESSION_LOG.md` nếu có việc đang làm dở
