...
export const HomePage: React.FC = () => {
  ...
  function getDynamicBanner() {
    ...
    if (hour >= 5 && hour < 10)
      return "https://zkeymmxuncvlrlezrbye.supabase.co/storage/v1/object/public/banner/banner_home/bannerhome_sang.png";
    if (hour >= 10 && hour < 14)
      return "https://zkeymmxuncvlrlezrbye.supabase.co/storage/v1/object/public/banner/banner_home/bannerhome_trua.png";
    if (hour >= 14 && hour < 18)
      return "https://zkeymmxuncvlrlezrbye.supabase.co/storage/v1/object/public/banner/banner_home/bannerhome_chieu.png";
    ...
    async function fetchPublicData() {
      try {
        ...
        if (postsRes.success) {
          ...
          setLatestPosts([...posts].sort(() => Math.random() - 0.5));
        }
      } catch (error) {
  ...
  return (
    <div style={{ backgroundColor: "var(--tc-bg-default)" }}>
              ...
              >
                ...
                >
                  ...
                  <input
                    ...
                    style={{
                      zIndex: minBudget > 50000000 ? 1002 : 1000,
                      width: "252px",
                      margin: 0,
                      padding: 0,
                      left: 0,
      ...
      {user && recommendedTours.length > 0 && (
        <section
          style={{
            padding: "var(--tc-spacing-8) var(--tc-spacing-5)",
            maxWidth: "1280px",
            margin: "0 auto",
            backgroundColor: "#f0f9ff",
            borderRadius: "var(--tc-radius-lg)",
            marginTop: "var(--tc-spacing-5)",
          }}
        >
          <div
            style={{
          ...
          >
            <div>
              ...
              <p style={{ color: "var(--tc-text-secondary)" }}>
                Dựa trên sở thích và ngân sách của {profile?.full_name}
              </p>
            </div>
          </div>
        ...
        >
          ...
          >
            <div>
              ...
              <p style={{ color: "var(--tc-text-secondary)" }}>
                Những hành trình được yêu thích nhất trong tuần
              </p>
            </div>
            <Link
              to="/tours"
        ...
        >
          ...
          >
            <div>
              ...
              >
                {t("home.featured_guides")}
              </h2>
              <p style={{ color: "var(--tc-text-secondary)" }}>
                Kết nối với người bản địa am hiểu khu vực
              </p>
            </div>
            <Link
              to="/guides"
                ...
                >
                  ...
                  >
                    ...
                    >
                      <span style={{ color: "#006ce4" }}>🎯</span>
                      Khu vực:{" "}
                      <span style={{ fontWeight: 600 }}>{guide.location}</span>
                    </div>
                    <div
                      style={{
                        display: "flex",
      ...
      >
        ...
        >
          <div>
            ...
            >
              {t("home.featured_companions")}
            </h2>
            <p style={{ color: "var(--tc-text-secondary)" }}>
              Cùng chia sẻ chi phí và niềm vui
            </p>
          </div>
          <Link
            to="/companions"
                ...
                >
                  <div
                    style={{
                      ...
                      fontWeight: 700,
                      color: "white",
                      backgroundColor: isPostExpired(post.startDate)
                        ? "var(--tc-text-secondary)"
                        : post.businessStatus === "open"
                          ? "var(--tc-success)"
                          : post.businessStatus === "completed"
                            ? "var(--tc-primary)"
                            : "var(--tc-text-secondary)",
                    }}
                  >
                    {isPostExpired(post.startDate)
                      ? "Đã kết thúc"
                      : post.businessStatus === "open"
                        ? "Đang tuyển"
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    Chi phí:{" "}
                    <span style={{ fontWeight: 700, color: "#e42b1f" }}>
                      {!isNaN(Number(post.estimatedCost)) 
                        ? Number(post.estimatedCost || 0).toLocaleString() 
                        : "0"}đ
                    </span>
                  </div>
                  <div
                  ...
                  >
                    <span style={{ color: "#006ce4" }}>📍</span>
                    Điểm đến:{" "}
                    <span style={{ fontWeight: 600 }}>{post.destination}</span>
                  </div>
                </div>
